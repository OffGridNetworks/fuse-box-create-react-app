This component project was bootstrapped with [Fuse-Box Create React App] (https://github.com/offgridnetworks/fuse-box-create-react-app).

## tl;dr

Develop your standalone react component in real time with the following command.    This version uses Storybook, but templates will be available for catalog and styleguidist too.
...
In most cases bumping the `react-scripts` version in `package.json` and running `npm install` in this folder should be enough, but it’s good to consult the [changelog](https://github.com/offgridnetworks/fuse-box-create-react-app/blob/master/CHANGELOG.md) for potential breaking changes.

We commit to keeping the breaking changes minimal so you can upgrade `react-scripts` painlessly.

## Sending Feedback

We are always open to [your feedback](https://github.com/offgridnetworks/fuse-box-create-react-app/issues).
...
Runs the storyboard in the development mode.<br>
...
Builds the component library for production to the `dist` and `dist-storyboook` folders.<br>
It correctly bundles React in production mode and optimizes the build for the best performance.

The build is minified and the filenames include the hashes.<br>
Your library is ready to be distributed!

See the section about [deployment](#deployment) for more information on deploying the storybook style guide.
...
- Infinite styles compiling [#1939](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/1939)
...
To reduce the number of requests to the server, importing images that are less than 10,000 bytes returns a [data URI](https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/Data_URIs) instead of a path. This applies to the following file extensions: bmp, gif, jpg, jpeg, and png. SVG files are excluded due to [#1153](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/1153).
...
>Note: You must create custom environment variables beginning with `REACT_APP_`. Any other variables except `NODE_ENV` will be ignored to avoid accidentally [exposing a private key on the machine that could have the same name](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/865#issuecomment-252199527). Changing any environment variables will require you to restart the development server if it is running.
...
* [#214](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/214)
* [#411](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/411)
...
This shouldn’t affect you when developing on `localhost`, but if you develop remotely like [described here](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/2271), you will see this error in the browser after enabling the `proxy` option:
...
>  If you find yourself doing this often in development, please [file an issue](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/new) to tell us about your use case because we want to make watcher the best experience and are open to changing how it works to accommodate more workflows.
...
>Note: This is a [change in default behavior](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/3248),
...
IMPORTANT: you need to set proper HTTP caching headers for `service-worker.js` file in `firebase.json` file or you will not be able to see changes after first deployment ([issue #2440](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/2440)). It should be added inside `"hosting"` key like next:
...
REACT_EDITOR | :white_check_mark: | :x: | When an app crashes in development, you will see an error overlay with clickable stack trace. When you click on it, Create React App will try to determine the editor you are using based on currently running processes, and open the relevant source file. You can [send a pull request to detect your editor of choice](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/2636). Setting this environment variable overrides the automatic detection. If you do it, make sure your systems [PATH](https://en.wikipedia.org/wiki/PATH_(variable)) environment variable points to your editor’s bin folder. You can also set it to `none` to disable it completely.
...
* If the watcher doesn’t see a file called `index.js` and you’re referencing it by the folder name, you [need to restart the watcher](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/1164) due to a Webpack bug.
...
If none of these solutions help please leave a comment [in this thread](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/659).

### `npm test` hangs on macOS Sierra

If you run `npm test` and the console gets stuck after printing `react-scripts test --env=jsdom` to the console there might be a problem with your [Watchman](https://facebook.github.io/watchman/) installation as described in [facebook/create-react-app#713](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/713).
...
[Ejecting](#npm-run-eject) lets you customize anything, but from that point on you have to maintain the configuration and scripts yourself. This can be daunting if you have many similar projects. In such cases instead of ejecting we recommend to *fork* `react-scripts` and any other packages you need. [This article](https://auth0.com/blog/how-to-configure-create-react-app/) dives into how to do it in depth. You can find more discussion in [this issue](https://github.com/offgridnetworks/fuse-box-create-react-app/issues/682).

## Something Missing?

If you have ideas for more “How To” recipes that should be on this page, [let us know](https://github.com/offgridnetworks/fuse-box-create-react-app/issues) or [contribute some!](https://github.com/offgridnetworks/fuse-box-create-react-app/edit/master/packages/react-scripts/template/README.md)
