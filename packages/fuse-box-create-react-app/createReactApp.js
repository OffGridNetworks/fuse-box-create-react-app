...
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
// fuse-box-create-react-app is installed globally on people's computers. This means
  ...
  .on('--help', () => {
    ...
    console.log(
      `      - a custom fork published on npm: ${chalk.green(
        'my-fuse-box-react-scripts'
      )}`
    );
    console.log(
      `      - a .tgz archive: ${chalk.green(
        'https://mysite.com/my-fuse-box-react-scripts-0.8.2.tgz'
      )}`
    );
    console.log(
      `      - a .tar.gz archive: ${chalk.green(
        'https://mysite.com/my-fuse-box-react-scripts-0.8.2.tar.gz'
      )}`
    );
    console.log(
...
function createApp(name, verbose, version, useNpm, template) {
  ...
  console.log(`Creating a new Fuse-Box React app in ${chalk.green(root)}.`);
  console.log();
        ...
        console.log(
          chalk.yellow(
            `You are using npm ${npmInfo.npmVersion} \n\n` +
              `Please update to npm 8 or higher for a better, fully supported experience.\n`
          )
        );
      }
    }
...
function run(
  ...
  const scriptDependencies = [packageToInstall];
...
function getPackageName(installPackage) {
  if (installPackage.match(/^.+\.(tgz|tar\.gz)$/)) {
    return getTemporaryDirectory()
      ...
      .catch(err => {
        // The package name could be with or without semver version, e.g. fuse-box-react-scripts-0.2.0-alpha.1.tgz
    ...
    // git+https://github.com/mycompany/fuse-box-react-scripts.git
    // git+ssh://github.com/mycompany/fuse-box-react-scripts.git#v1.2.3
    ...
    console.error(
      chalk.red(
        'You are running Node %s.\n' +
          'Fuse BoxCreate React App requires Node %s or higher. \n' +
...
function checkAppName(appName) {
  ...
  let devDependencies = ['fuse-box-react-scripts'];
  dependencies = dependencies.concat(devDependencies).sort();
...
// https://github.com/offgridnetworks/fuse-box-create-react-app/pull/368#issuecomment-243446094
